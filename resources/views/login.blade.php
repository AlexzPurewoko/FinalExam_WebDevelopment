...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="md:container md:mx-auto">
            ...
            <form class="mt-12" action="{{{ route('login.post') }}}" method="post">
                @csrf
            ...
            <p class="mt-6 md:text-lg text-center">Belum punya akun ? <a class="underline text-sky-500" href="{{{ route('register') }}}">Buat akun</a></p>
        </div>
    </body>
</html>
